          ...
          {...footerProductsUrls
            ...
            .map((product: any, i: any) => (
              <Link
                ...
                href={product.url}
                className="hover:bg-[#72b901c4] bg-[#74B901] flex items-center justify-between py-2 w-full text-center hover:bg-opacity-20 duration-500 text-sm p-3 text-center"
              >
