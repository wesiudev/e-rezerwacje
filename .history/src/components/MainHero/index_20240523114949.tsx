  ...
  return (
    <div className="lg:grid grid-cols-2 py-24 pl-4 md:pl-8 lg:pl-12 xl:pl-20 2xl:pl-32 ">
      <div className="flex flex-col">
        <h1 className="text-6xl font-bold text-center lg:text-left text-zinc-800 drop-shadow-xl shadow-black">
          SYSTEMY REZERWACJI
        </h1>
        <p className="italic mt-12 font-light text-lg text-gray-600">
          ...
          każdej stronie. Utwórz i skonfiguruj swoje konto klienta już dziś.
        </p>
        <Link
          href="/dashboard"
