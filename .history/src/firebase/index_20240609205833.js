...
const firebaseConfigAdminLogin = {
  ...
  measurementId: process.env.NEXT_PUBLIC_FIREBASE_MEASURMENT_ID_ADMIN,
};
export const app = initializeApp(firebaseConfig);
export const app2 = initializeApp(firebaseConfigAdminLogin, "admin-login");
...
export async function userUpdate(uid, data) {
  ...
  if (!userDocSnap.exists()) {
    ...
    await setDoc(userDocRef, { ...data, lastLoggedIn: new Date() });
  } else {
    await updateDoc(userDocRef, { ...data, lastLoggedIn: new Date() });
  }
}
}
