              ...
              <div className="mb-12 flex flex-wrap space-x-3 space-y-3">
                {weekDays.map((day: any, i: any) => (
                  <button
                    ...
                    className={`${
                      i === 0 && "mt-3 ml-3"
                    } px-3 py-1 text-white font-bold bg-blue-500 relative`}
                  >
                    {day}
                    {userHours[i].name === day && (
                      <div className="w-full bottom-0 left-0 text-sm bg-red-500 text-white font-bold">
                        {userHours[i].hours.length === 0 && "Brak Godzin"}
                      </div>
                    )}
                  </button>
                ))}
