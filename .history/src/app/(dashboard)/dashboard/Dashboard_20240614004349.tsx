...
export default function Dashboard() {
  ...
  const [choosingHoursInDayIndexedByNumber, setChoosingHoursInDayIndexedByNumber] = useState(-1);
  ...
  return (
    <>
      ...
      {weekMenu && (
        <ChooseHoursInADay
          setChoosingHoursInDayIndexedByNumber={setChoosingHoursInDayIndexedByNumber}
