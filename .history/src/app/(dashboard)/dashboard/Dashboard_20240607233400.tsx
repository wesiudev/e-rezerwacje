          ...
          <div className="mt-12 grid grid-cols-1 lg:grid-cols-2 gap-3 ">
            ...
            <div className="bg-white rounded-xl h-max shadow-sm shadow-black">
              ...
              <div className="bg-gray-300">
                <div className="w-full p-3 py-6  rounded-b-xl text-zinc-700 text-center flex items-center justify-center relative">
                  <span className="text-sm sm:text-lg">Dni pracy</span>
                </div>
              </div>
              {/* <UserInvitations
