          ...
          <div className="mt-12 grid grid-cols-1 gap-3">
            <div className="bg-white rounded-xl shadow-sm shadow-black ">
              ...
              {userData?.userHours.filter((day: any) => day.hours.length > 0)
                .length === 0 && (
                <div className="bg-zinc-800 text-white font-light font-gotham p-3 drop-shadow-lg shadow-black flex items-center">
                  <div className="w-12 h-12 bg-white bg-opacity-10 rounded-xl mr-4 flex items-center justify-center mx-3">
