          ...
          <div className="mt-12 grid grid-cols-1 gap-3">
            <div className="bg-white rounded-xl shadow-sm shadow-black ">
              ...
              {userData?.userHours.filter((day: any) => day.hours.length > 0)
                .length === 0 && (
                <div className="bg-zinc-800 text-white font-bold p-3 drop-shadow-lg shadow-black flex items-center">
                  <div className="w-12 h-12 bg-white bg-opacity-10 rounded-xl mr-6">
                    <FaInfoCircle className="text-green-500 mr-2 h-6 w-6" />
                  </div>
