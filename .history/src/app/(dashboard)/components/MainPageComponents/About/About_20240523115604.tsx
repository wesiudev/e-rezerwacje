    ...
    <div className="min-h-[50vh] w-full px-4 md:px-8 lg:px-12 xl:px-20 2xl:px-32 py-12 lg:py-20 bg-billboard bg-cover bg-center md:bg-left relative flex items-center justify-center">
      ...
      <div className="group flex flex-col items-center justify-center w-full relative z-10">
        <Image
          ...
          height={1024}
          alt=""
          className="z-0 absolute inset-0 object-cover w-full h-full group-hover:scale-110 duration-500"
        />
        <h2 className=" text-[#009CE5] text-2xl sm:text-3xl lg:text-4xl drop-shadow-xl shadow-black text-center mb-4">
