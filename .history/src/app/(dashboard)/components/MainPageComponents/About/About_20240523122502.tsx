  ...
  return (
    <div className="min-h-[50vh] w-full px-4 md:px-8 lg:px-12 xl:px-20 2xl:px-32 py-12 lg:py-20 bg-billboard bg-cover bg-center md:bg-left relative flex items-center justify-center overflow-hidden">
      ...
      <div className="group flex flex-col items-center justify-center w-full relative z-10">
        ...
        />
        <div className="absolute z-[1] bg-black w-full h-full left-0 top-0 bg-opacity-80 scale-150 rotate-[30deg]" />
        <h2 className=" text-white text-2xl sm:text-3xl lg:text-4xl drop-shadow-xl shadow-black text-center mb-4 z-50 relative">
        ...
        <Link
          href="/o-firmie"
          className="font-bold text-white hover:underline group flex items-center mt-8 z-[50] relative"
        >
          Czytaj dalej
