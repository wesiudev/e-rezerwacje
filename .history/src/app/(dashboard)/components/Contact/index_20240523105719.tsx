  ...
  return (
    <div className="flex flex-col bg-[#74B901] p-6 w-full">
      ...
      <select
        ...
        name="reciever"
      >
        <option value="biuro@e-rezerwacje.com.pl" className="font-light">
          Biuro
        </option>
        <option value="pawel@e-rezerwacje.com.pl" className="font-light">
          Paweł
        </option>
        <option value="marcin@e-rezerwacje.com.pl" className="font-light">
          marcin
        </option>
      </select>
