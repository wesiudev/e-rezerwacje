  ...
  return (
    ...
    >
      <div className="flex md:flex-row flex-col items-center justify-evenly relative font-light">
        ...
        <Link
          href={`${
            (currentMailVisible === 1 && "mailto:biuro@e-rezerwacje.com") ||
            (currentMailVisible === 2 && "mailto:pawel@e-rezerwacje.com") ||
            (currentMailVisible === 3 && "mailto:marcin@e-rezerwacje.com")
          }`}
          className="relative group sm:ml-[100px] xl:ml-0 font-light py-3 lg:py-0"
          title="Zamówienie Reklamy Grudziądz"
        >
