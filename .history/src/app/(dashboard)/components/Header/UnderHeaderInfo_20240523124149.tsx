    ...
    <div
      className={`${
        isSticky
          ...
          : "fixed top-[0px]"
      } left-0 z-[30] bg-[#74B901] text-white w-full py-0.5 flex flex-wrap items-center justify-center space-x-6 sm:space-x-0 sm:justify-between xl:justify-evenly px-4 md:px-8 lg:px-12 xl:px-20 2xl:px-32 duration-300 text-[13px] sm:text-base font-light z-[190]`}
    >
