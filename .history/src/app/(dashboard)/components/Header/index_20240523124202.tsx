  ...
  return (
    <>
      ...
      <div
        ...
        className={`z-[190] fixed grid grid-cols-2 w-full max-h-[86.5vh] top-0 left-0 bg-white xl:space-x-3 font-semibold shadow-black ${
          hovered
      ...
      <div
        className={`fixed w-full max-h-[88vh] overflow-y-scroll pb-20 top-0 left-0 bg-gray-300 bg-opacity-90 xl:space-x-3 xl:-ml-3 font-semibold shadow-black ${
          productsOpen
            ? "translate-y-[96px] lg:translate-y-[128px] opacity-100 z-[500]"
            : "z-[-10] opacity-0"
...
const additionalServices = [
  ...
  { urlLabel: "Zobacz więcej", url: "/system-rezerwacji", color: "#74B901" }, // Pastel Purple
];
