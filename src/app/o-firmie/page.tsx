    ...
    <>
      ...
      <div className="sm:mt-[130px] w-full relative flex flex-row flex-wrap p-12 space-x-12">
        ...
        <p className="text-justify sm:text-left sm:max-w-[40rem] font-light">
          Oferujemy instalację nowoczesnych, intuicyjnych systemów rezerwacji,
          które doskonale integrują się z każdą stroną internetową. Nasze
          rozwiązania zapewniają łatwość obsługi zarówno dla użytkowników, jak i
          administratorów.{" "}
        </p>
        <p className="text-justify sm:text-left sm:max-w-[40rem] font-light">
          Stwórz konto już dziś i zacznij korzystać z naszego zaawansowanego
          systemu rezerwacji, który usprawni zarządzanie rezerwacjami i poprawi
