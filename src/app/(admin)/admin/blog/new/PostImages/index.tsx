              ...
              >
                <div className="absolute -left-3 -top-3 w-max h-6">
                  <div className="group flex flex-row">
                    ...
                    >
                      <div className="text-white text-2xl bg-green-400 rounded-full block duration-200 relative z-[15]">
                        <FaPlusSquare />
                      </div>
                    </button>
                ...
                {item.alt === "" && (
                  <div className="absolute -right-3 -top-3 w-6 h-6">
                    <div className="group flex flex-row">
                      <div className="text-white text-2xl bg-red-400 rounded-full block duration-200 relative z-[15]">
                        <FaExclamationCircle />
                      </div>
